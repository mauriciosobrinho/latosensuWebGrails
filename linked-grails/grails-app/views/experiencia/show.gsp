...
<html>
    ...
    <body>
        ...
        <div id="show-experiencia" class="content scaffold-show" role="main">
            ...
            <f:display bean="experiencia" />
            <g:form resource="${this.experiencia}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.experiencia}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
